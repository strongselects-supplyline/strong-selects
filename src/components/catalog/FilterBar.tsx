...
export function FilterBar() {
    ...
    return (
        <div className="w-full overflow-x-auto py-4 no-scrollbar border-b border-border sticky top-16 z-40" style={{ backgroundColor: '#0a0a0a', transform: 'translateZ(0)', WebkitOverflowScrolling: 'touch' }}>
